...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (HOTLOCK_STORAGE['button_hover'] && HOTLOCK_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.hotlock_tabs .hotlock_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+HOTLOCK_STORAGE['button_hover']);
		if (HOTLOCK_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.post_item_single .post_content .post_meta .post_share .social_item a\
				').addClass('sc_button_hover_just_init sc_button_hover_style_hover sc_button_hover_style_alter');
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.hotlock_tabs .hotlock_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+HOTLOCK_STORAGE['button_hover']);
