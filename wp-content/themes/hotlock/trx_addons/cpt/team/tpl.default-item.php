...
<div class="sc_team_item">
	...
	set_query_var('trx_addons_args_featured', array(
		...
		'hover' => 'zoomin',
		'thumb_size' => apply_filters('trx_addons_filter_team_thumb_size', trx_addons_get_thumb_size('team_avatar'))
	));
	...
	<div class="sc_team_item_info">
		...
		?>
		<div class="sc_team_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button sc_button_simple"><?php esc_html_e('Learn more', 'hotlock'); ?></a></div>
	</div>
</div>
<?php
